...
Earlier work: [ten lossless optimization experiments](experiments/ten-rounds.md), with two retained changes and eight rejected/deferred/reverted candidates. Historical snapshots: [Adreno 730](baselines/a730-ten-rounds.md) and [G720 cross-check](baselines/g720-ten-rounds.md). These are compile-time findings and source-work reductions, not measured phone speedups.
