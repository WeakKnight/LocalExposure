...
Defaults are 1920x1080, `guided-fused-reconstruction`, R11G11B10 input and RGBA8 sRGB output.
...
Use `--variant guided-direct-tail` or `--variant lossless` on the first command for
