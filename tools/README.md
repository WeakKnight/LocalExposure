...
See the [profiling guide](../docs/performance/README.md) for setup and interpretation. Generated files live in `outputs/`; downloaded compilers live in `.tools/`. Both directories are ignored by Git.
