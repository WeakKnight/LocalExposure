...
def estimate(manifest, fps=45):
    ...
    for p in manifest['passes']:
        ...
        if entry == 'tail_reconstruct':
            ...
            radius=manifest['config'].get('variant_settings',{}).get('guided_radius',2)
